          ...
          <div className="flex items-center gap-8">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="relative w-24 h-24 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-600 hover:from-emerald-400 hover:to-emerald-500 active:from-emerald-600 active:to-emerald-700 flex items-center justify-center shadow-2xl hover:shadow-2xl hover:shadow-emerald-500/50 transition-all duration-200 active:scale-95 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:ring-offset-2 focus:ring-offset-stone-950"
              >
